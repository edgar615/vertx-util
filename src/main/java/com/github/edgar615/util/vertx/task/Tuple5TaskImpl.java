 ...
 */
class Tuple5TaskImpl<T1, T2, T3, T4, T5> extends BaseTask<Tuple5<T1, T2, T3, T4, T5>> implements
        Tuple5Task<T1, T2, T3, T4, T5> {

  Tuple5TaskImpl(String name, Future<T1> futureT1, Future<T2> futureT2, Future<T3> futureT3,
                 Future<T4> futureT4, Future<T5> futureT5) {
  ...
  Tuple5TaskImpl(Future<T1> futureT1, Future<T2> futureT2, Future<T3> futureT3, Future<T4> futureT4,
                 Future<T5> futureT5) {
